[![Run App Kolton ONeal](https://github.com/Mathyland/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Mathyland/GithubActions/actions/workflows/run-app.yaml)
